...
public class Main {
    public static void main(String[] args) {
        PositionalTreeExample treeExample = new PositionalTreeExample("Electronics R'Us");
        TreeNode<String> root = treeExample.getRoot();

        treeExample.displayTreeWithIterator();
            ...
            switch (choice) {
                ...
                case 9:
                    ...
                    if (parentNode != null) {
                        ...
                        treeExample.displayTreeWithIterator();  // Display the updated tree
                    } else {
